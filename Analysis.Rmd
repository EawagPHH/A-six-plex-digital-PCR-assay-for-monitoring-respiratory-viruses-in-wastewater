...
save_image(p = abundance.plot, file = "figures/ReviewFigure1.png", width = 750, height = 750, scale = 5)
```
...
save_image(p = cv.plot, file = "figures/ReviewFigure2.png", width = 750, height = 750, scale = 5)
...
save_image(p = N1.N2.ratio.plot, file = "figures/SupFigure2.png", width = 750, height = 1000, scale = 5)
...
N1.N2.ratio.plot.data %>%
  ...
  print() %>%
  write_csv(., "tables/SupTable7-FigS2.csv")
```
...
save_image(p = wwtps.loads.plot, file = "figures/SupFigure3.png", width = 750, height = 750, scale = 5)
...
for(i in 1:length(cases.report.loads.plot)) {
  ...
  save_image(p = cases.report.loads.plot[[i]],
             file = paste0("figures/SupFigure4-", unique(swissAvgData$pathogen)[i], ".png"),
...
for (i in 1:length(unique(swissAvgData$pathogen))) {
  ...
  swissAvgData %>%
    ...
    print() %>%
    write.csv(., paste0("tables/SupTable7-FigS4-", unique(.$pathogen), ".csv"))
}
...
save_image(p = sentinella.lags, file = "figures/SupFigure5.png", width = 750, height = 1000, scale = 5)
